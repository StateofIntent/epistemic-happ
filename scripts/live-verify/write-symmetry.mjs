...
// file.
//
//   Regression injected: making the reinforce handler a no-op.
//   Result: two FAILs — the displayed conductance never rises, and an independent client confirms it did not rise on the DHT either.
//
